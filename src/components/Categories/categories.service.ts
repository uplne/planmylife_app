...
export const getCategoriesAPI = async () => {
  try {
    ...
    throw new Error(`Get categories: ${e}`);
  }
};
...
export const saveCategoryAPI = async (category: CategoryAPITypes) => {
  try {
    ...
    throw new Error(`Failed to save task: ${category.categoryId}, error: ${e}`);
  }
};
