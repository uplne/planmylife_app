...
export const TaskListItem = ({
  ...
  if (length === 1 && !isSub) {
    classes = `relative before:absolute before:top-2/4 before:block before:content-[''] before:w-2 before:h-[1px] before:border-t before:border-0 before:border-solid before:border-borderSecondary after:absolute after:top-0 after:left-[-1px] after:block after:content-[''] after:w-[1px] after:h-full after:bg-[white]`;
  }
